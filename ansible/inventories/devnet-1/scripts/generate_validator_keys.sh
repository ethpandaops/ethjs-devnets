...
function prep_group {
  ...
  genesis_root=$(cat ../../../../network-configs/devnet-1/parsedBeaconState.json| jq -r .genesis_validators_root)
  genesis_version=$(cat ../../../../network-configs/devnet-1/config.yaml| yq .GENESIS_FORK_VERSION)
